...
type Row = [
  ...
  confidence: number,
  pageNumber: number,
  /** Ghi chú của chuyên gia — chỉ vài dòng có, mock để dựng giao diện. */
  note?: string,
];
...
/**
 * Vùng khoanh mock — sinh ngẫu nhiên có seed cố định theo thứ tự dòng, để mỗi
 * lần build ra cùng một kết quả (không đổi lung tung giữa các lần chạy dev).
 * Chưa có backend để trả về tọa độ khoanh vùng thật do VLM xác định.
 */
