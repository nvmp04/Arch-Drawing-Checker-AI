/**
 * Bộ icon nội bộ — SVG inline, không phụ thuộc package ngoài.
 * Stroke 1.5, viewBox 24, mặc định size-4 (16px) khớp text-sm của sidebar.
 * Khi dự án cài lucide-react thì thay dần bằng icon của lucide, giữ nguyên tên.
 */
